...
APP_CONTAINER_IMAGE=my-node-jwt-app
APP_CONTAINER_NAME=node-jwt-app
APP_DOCKER_CONTEXT=.
...
POSTGRES_CONTAINER_IMAGE=my-node-jwt-postgres
POSTGRES_CONTAINER_NAME=node-jwt-postgres
